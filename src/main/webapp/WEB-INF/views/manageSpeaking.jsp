...
tr {
	...
	table{
	 height:220px;              // <-- Select the height of the table
...
<div class = "col-lg-9 col-sm-9"><form class = "form-group">
	...
	<label class = "radio-inline">
		<input type = "radio" name = "part" value = "3"> Part 3
	</label>
</form>
</div>
</div>
...
<button class = "btn btn-warning" style = "float:right" onclick = "addQuestion('1')">Add question</button>
</div>
</div>
</body>
</html>